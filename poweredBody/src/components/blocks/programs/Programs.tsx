      ...
      <div className={styles.cards}>
        <div className={styles.cardContainer}>
          ...
          <div className={styles.card}>
            ...
            Всего 35-40 минут — и вы в тонусе. Поддержка тренера, полезные советы по бытовым привычкам и самостоятельным занятиям, проверка техники, групповая динамика, а общий чат станет местом для вопросов и мотивации. Записи занятий всегда под рукой.
            </p>
          </div>
